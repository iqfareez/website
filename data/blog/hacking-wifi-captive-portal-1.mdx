...
<Admonition type="note">You can also use ESP8266 etc.</Admonition>
...
Full code: https://gist.github.com/iqfareez/4861c6e5dc76c1190d8b1651def13d37
...
In the upcoming part 2 article, we will see how to use this log in trick using laptop or phone to ease log in.
