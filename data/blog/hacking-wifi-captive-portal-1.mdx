...
To verify if there your ESP32 is connected to the internet, you can make a request to any API, and see if it returns something. You could use this `https://iqfareez.com/api/hello` simple API for testing.
