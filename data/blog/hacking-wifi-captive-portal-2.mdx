...
As you might notice, the speed of the powershell script is quite slow. I made another script with Dart, and compile it to the native binary. It run significantly faster. Hopefully I can put the repo link here when it's ready.
