...
In this article, I'm going to share on how you can log in to the captive portal with just **one click**.
No web browser is needed,
so we can save our time without typing down the username and password everytime we need to use the internet.

If you have no idea about what is captive portal etc.,
do have read the [first part](hacking-wifi-captive-portal-1) of this article.

![Desktop shortcut login wifi](/static/blog/hack-wifi-2/shortcut_login_iium.jpg)

## Basic principles

We understand that by making a **POST request** with correct credentials will [authenticate ourselves](hacking-wifi-captive-portal-1#testing-and-verifying) to
Wi-Fi.
...
But no worries, as this method can be adopted to other platforms.
...
That's it, now you know on how to log in to Wi-Fi captive portal without 'entering' the captive portal.
