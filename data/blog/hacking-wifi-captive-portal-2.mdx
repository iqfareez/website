...
(**Bonus**) As you might notice, the speed of the [powershell script](#run-the-shortcut) is quite slow. I made another script using [Dart](https://dart.dev/), and compile it to the native binary. It runs significantly faster ⚡. Create one for yourself now [here](https://github.com/iqfareez/dart_captive_portal_login).
