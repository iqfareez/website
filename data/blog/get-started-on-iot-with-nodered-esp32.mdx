...
[//]: # 'letak gambar nodered-started'

Once started. Open the instance link (eg: `http://127.0.0.1:1880/`) in the browser. You should see something like this:

[//]: # 'letak gambar nodered-welcome'
...
[//]: # 'letak gambar mqtt broker field'
