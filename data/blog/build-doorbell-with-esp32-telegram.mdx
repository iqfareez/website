...
Let's try an example: Replace the `<BOTTOKEN>` with your token, copy the URL and paste it in your browser. A message `Hello world` should arrive
to your Telegram.

`https://api.telegram.org/bot<BOTTOKEN>/sendMessage?chat_id=320195187&text=Hello%20world`
