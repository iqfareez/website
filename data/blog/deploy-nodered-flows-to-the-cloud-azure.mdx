...
<Admonition type={'note'}>
  As soon I finish writing this tutorial, I realized that you can connect to the VM's shell by just
...
<Admonition type="tip">
  You may wanted to save the PuTTY session, so next time you want to access the Shell, just load the
  session from disk
</Admonition>
...
a flows before this locally, why not just importing the flows to the Azure VM? Continue reading...
